...
export default function Contact() {
  return (
    <div className="min-h-full pt-5 sm:px-10 md:pt-12 md:pb-[6.5rem] md:px-14 lg:px-[4.5rem] xl:px-[5.5rem] 2xl:px-[6.5rem] lg:grid lg:grid-rows-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-12">
